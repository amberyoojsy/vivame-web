...
* 🦐 제철 음식(방어, 대하 등)에 진심인 미식가 CP님`,
  ...
  },
  {
    ...
    summary:
      "매 활동 시 최소 15명 이상 참여하는 활기찬 분위기!\n\n자유로운 출석 속에서 함께 땀 흘리며\n새로운 도전을 즐길 CP님들을 기다립니다.",
...
* 🤝 처음 만나도 금방 친해지는 활발하고 에너지 넘치는 분`,
  ...
  },
  {
    ...
    summary:
      '"프사 바꿀 때 되셨나요? 여기서 해결해 드립니다!"\n\n찰나의 순간을 기록하고 싶은 분이라면\n기종 상관없이 누구나 환영합니다.',
...
* ✨ 평범한 일상을 특별한 작품으로 남기고 싶은 감성 CP님`,
  ...
  },
  {
    ...
    summary:
      "주 2회 꾸준한 활동과 매력적인 자체 굿즈까지!\n\n확실한 운동 효과는 물론,\n분기별 고급 회식으로 즐거움까지 놓치지 않는\n비상 최대 규모의 모임입니다.",
...
* 🤝 외부인 없는 쾌적한 공간에서 새로운 동료들과 친해지고 싶은 분`,
  ...
  },
  {
    ...
    summary:
      '"함께 지식을 나눈다."\n\n독서를 통해 새로운 인사이트를 얻고 싶은\nCP님이라면 누구나 환영합니다!\n\n지적 호기심을 채우고 싶은 마음 하나면 충분합니다.',
...
* 🏟️ 혼자 가는 직관보다 함께 응원하는 함성의 힘을 믿는 분`,
  ...
  },
  {
    ...
    summary:
      "실력 부담은 내려놓고\n푸른 잔디 위에서 에너지를 충전하세요.\n\n유쾌하고 좋은 사람들과 함께라면\n벙커도 해저드도 즐거운 추억이 됩니다!",
...
* 🤝 함께의 가치를 아는 분: 혼자 연습장 가는 것보다, 부족해도 함께 라운딩하며 추억 쌓기를 즐기는 분.`,
  ...
  {
    name: "온니 플라워",
    tagline: "꽃과 함께 피어나는 일상의 힐링,\n한 달에 한 번 나에게 주는 선물",
    summary:
      "월 참여도 90% 이상을 자랑하는\n비상의 대표 힐링\u00A0모임!\n\n직접 만든 꽃 작품으로 업무 스트레스는 해소하고,\n사내 분위기까지 화사하게 업그레이드합니다.",
...
* 🤝 밝고 유쾌한 분위기 속에서 사내 네트워크를 넓히고 싶은 CP님`,
  ...
  },
  {
    ...
    summary:
      "매달 새로운 맛집 도장 깨기부터\n자유로운 콘솔 게임까지!\n\n미식과 취미를 공유하며 일상의 즐거움을\n발견할 파티원을 모집합니다.",
    detail: `자유로운 활동을 지향하는 'AVOCADO'입니다!

저희는 매달 1회 배달 맛집 도장 깨기를 진행하며
맛있는 시간을 가집니다.
