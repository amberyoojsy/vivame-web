...
var CLUB_PORTAL_CLUBS = [
  {
    ...
    detail: `압도적인 팔 힘과 퍼포먼스를 빠르게 만들어드리는 '그립'입니다!
바쁜 업무 중에도 효율적으로 운동하고 싶은 분들을 위해 준비했습니다.

저희 동호회는 별도의 장비가 전혀 필요 없습니다.
초크, 초크백, 테이프 등 활동에 필요한 모든 장비를 전폭 지원해 드립니다!
열정만 있다면 누구나 최고의 신체 변화와 성취감을 경험할 수 있습니다.

운동 잘해 보이고 싶은 CP님들, 지금 바로 그립과 함께 한계를 뛰어넘어 보세요!
...
* 🤝 동료들과 함께 한계를 극복하며 끈끈한 팀워크를 느끼고 싶은 분`,
  ...
  },
  {
    ...
    detail: `'포시즌스' 이름값 합니다!
저희는 매달 계절을 가장 잘 느낄 수 있는 제철 활동을 함께 찾고 야무지게 즐기고 있습니다.
아마도 비상교육에서 봄, 여름, 가을, 겨울을 가장 잘 즐기고 있는 모임이 아닐까 싶어요! (｡•̀ᴗ-)✧
...
이렇게 사계절을 알차게 보냈고, 다가오는 계절에도 또 새로운 즐거움을 함께 찾아갈 예정입니다.

동호회 특성상 제철 맛집이나 행사 위주로 활동하다 보니 경우에 따라 개인 비용이 들기도 하지만,
이런 부분도 부담 없이 함께 즐기실 수 있는 분이라면 더욱 환영합니다!
...
* 🦐 제철 음식(방어, 대하 등)에 진심인 미식가 CP님`,
  ...
  },
  {
    ...
    detail: `즐거운 분위기와 자유로운 출석을 지향하는 '비상턴'입니다!
저희 동호회는 매 활동마다 최소 15명 이상 참여할 정도로 아주 높은 활동성을 자랑하고 있어요.

서로 격려하며 기분 좋게 몸을 움직이다 보면 일상의 스트레스가 금방 해소됩니다.
실력에 상관없이 함께 에너지를 나누고 싶은 마음만 있다면 누구나 환영합니다.

새해를 맞아 새로운 것을 꼭 배워보고 싶었던 CP님들이라면 주저 말고 비상턴의 문을 두드려보세요!
...
* 💪 동료들과 함께 건강한 활력을 찾고 싶은 모든 분`,
  ...
  },
  {
    ...
    detail: `말 그대로 '모종'으로 시작하는 우리들의 초록색 프로젝트!
회사 옥상이라는 특별한 공간에서 식물을 키우며 도심 속 농부의 삶을 경험합니다.

'장비빨' 좀 세우고 싶은 가드닝 장비 마니아부터, 내 식물은 내가 책임지는 '주인정신' 투철한 분들까지 모두 환영합니다.
옥상에서 함께 땀 흘리고 식물이 자라는 모습을 보며 업무 스트레스를 건강하게 해소해 보세요.
...
* 🥬 직접 키운 작물을 수확하는 정직한 성취감을 느끼고 싶은 분`,
  ...
  },
  {
    ...
    detail: `그림책을 통한 진정한 힐링! 숲속과 바다로 직접 가지 않아도 됩니다.
비상교육에서 숲속도, 바다도, 또 우주도—내가 상상하는 모든 공간으로 이동이 가능합니다.

복잡한 세상에서 벗어나 시간과 공간을 초월한 그림책의 세계에서 함께 힐링해요!
거창한 준비물은 필요 없습니다. "그림책 놀이터에서 즐겁게 놀 마인드"만 가지고 오시면 됩니다.

그림책이 주는 짧지만 깊은 울림을 함께 나눌 CP님들을 기다립니다.
...
* 🪐 시공간을 초월한 새로운 힐링 경험을 해보고 싶은 분`,
  ...
  },
  {
    ...
    detail: `일상의 중력을 벗어나 미지의 세계를 탐험하는 즐거움!
'퐁당다이브클럽'은 물속에서 느끼는 고요한 평온과 다이빙이 주는 짜릿한 성취감을 함께 나누는 모임입니다.

쉽게 경험할 수 없는 특별한 활동을 통해 새로운 나를 발견하고,
물속에서 만들어지는 끈끈한 유대감을 경험해 보세요.

꾸준히 함께하며 물과 친해질 준비가 된 분들이라면 언제든 환영합니다!
...
* ✨ 일상에 활력을 불어넣을 색다른 도전을 즐기시는 분`,
  ...
  },
  {
    ...
    detail: `서울의 핫플레이스 팝업 스토어부터 SNS에서 난리 난 트렌디한 공간까지!
'팝케팅'은 지금 가장 뜨거운 현장을 직접 발로 뛰며 트렌드를 발견하고 즐기는 동호회입니다.
처음 만나는 사이라도 금방 친해지는 활발하고 에너지 넘치는 분위기를 자랑합니다.

혼자 가기 쑥스러웠던 핫플들, 이제 팝케팅 멤버들과 함께 영감을 채우러 떠나보세요!
...
* 🤝 처음 만나도 금방 친해지는 활발하고 에너지 넘치는 분`,
  ...
  },
  {
    ...
    detail: `소중한 순간을 영원히 남기고 싶은 'Focus on'입니다.
거창한 장비가 없어도 괜찮습니다.

휴대폰 카메라든 전문 DSLR이든, '이건 꼭 남겨야겠다' 싶은 순간에 자연스럽게 손이 먼저 나가는 분이라면 이미 저희와 함께할 준비가 되신 거예요!

출사를 통해 멋진 풍경도 담고, 동료들과 서로 인생샷을 남겨주며 일상의 프사를 새롭게 바꿔보세요. :)
...
* ✨ 평범한 일상을 특별한 작품으로 남기고 싶은 감성 CP님`,
  ...
  },
  {
    ...
    detail: `비상에서 가장 활발한 에너지를 자랑하는 '원모어(One More)'입니다!
저희는 주 2회의 잦은 활동 빈도로 꾸준한 건강 관리를 지향합니다.

운동만 하는 곳이냐고요? 아닙니다!
원모어만의 매력적인 자체 굿즈와 분기별로 진행되는 고급 회식은 우리 동호회의 또 다른 자랑거리입니다.

외부인이 없는 우리만의 편안한 공간에서 땀 흘리고, 새로운 CP님들과 소통하며 활력을 충전해 보세요!
...
* 🤝 외부인 없는 쾌적한 공간에서 새로운 동료들과 친해지고 싶은 분`,
  ...
  },
  {
    ...
    detail: `혼자 읽기보다 함께 나눌 때 지식은 더욱 깊어집니다.
'비상다독'은 책을 통해 다양한 생각과 정보를 공유하며 함께 성장하는 모임입니다.

어려운 책이 아니어도 괜찮습니다.
지식을 나누고 싶은 열정만 있다면 자격 제한 없이 "아무나!" 참여 가능합니다.

바쁜 일상 속에서 잠시 책장을 넘기며 동료들과 지적 힐링의 시간을 가져보세요.
...
* 🗨️ 읽은 책에 대해 자유롭게 이야기 나누는 문화를 선호하는 분`,
  ...
  },
  {
    ...
    detail: `'다양한 스포츠 관람을 지향하는 모임', 다람지입니다!
저희는 특정 종목에 국한되지 않고 야구, 축구, 배구 등 현장의 에너지를 느낄 수 있는 곳이라면 어디든 함께합니다.

화려한 이벤트보다는 스포츠 그 자체를 즐기며, 조용하지만 꾸준하게 활동을 이어가는 것이 저희의 자랑거리입니다.

스포츠 결과에 하루하루 웃고 우는 진정한 팬심을 가진 분들이라면 다람지에서 함께 직관의 매력에 빠져보세요!
...
* 🏟️ 혼자 가는 직관보다 함께 응원하는 함성의 힘을 믿는 분`,
  ...
  },
  {
    ...
    detail: `저희 '비상골린이들'의 가장 큰 자랑은 단연 사람입니다.
유쾌하고 좋은 사람들과 함께라면 헛스윙 한 번에도 웃음꽃이 피어납니다.
꼭 공을 잘 쳐야만 즐거운 건 아니잖아요?

사무실을 벗어나 탁 트인 푸른 잔디 위에서 동료들과 함께 게임을 즐기는 것 자체가 저희에게는 최고의 에너지 충전입니다.

실력 부담 없이, 필드가 주는 개방감을 만끽하고 싶은 분들이라면 우리 동호회가 정답입니다!
...
동료나 소중한 가족(어머니, 배우자, 자녀 등)에게 직접 만든 꽃을 선물하며 일주일 이상의 깊은 힐링을 경험해 보세요.

꽃과 식물을 사랑하는 CP님이라면 누구나 환영합니다!
...
저희는 스트레스를 핀처럼 날려버리고 싶은 분, 다양한 부서원들과 유쾌하게 연결되고 싶은 분들을 언제나 환영합니다.

볼링을 처음 접하시나요? 준비물이나 진입장벽은 전혀 없습니다.
공만 굴릴 수 있다면 볼링 고수들의 연속 스트라이크 노하우를 무료로 전수받을 수 있는 기회까지 드립니다.

즐겁게 게임을 마친 후에는 인덕원 맛집 탐방으로 하루를 완벽하게 마무리합니다.
...
저희는 매달 1회 배달 맛집 도장 깨기를 진행하며 맛있는 시간을 가집니다.

맛집 탐방 외에도 콘솔 종류 무관, 장르 무관하게 같이 즐길 게임 친구를 구하고 있습니다.

"먼저 겜 같이 하자고 적극적으로 파티원 모집할 용기가 있으신 분", "즐겜러보다 빡겜러를 추구하시는 분" 모두 환영합니다!

아보카도와 함께라면 지루할 틈 없는 회사 생활이 펼쳐질 거예요.
포기하지 말고 문을 두드려주세요!
